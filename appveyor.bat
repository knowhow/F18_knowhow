...
bash -xlc "export HB_ARCHITECTURE=win; export HB_COMPILER=mingw; export F18_VER=${F18_VERSION:=0.0.0} ; scripts/update_f18_ver_ch.sh $F18_VER; export F18_POS=1; source scripts/mingw_appveyor_set_envars.sh ; hbmk2 -workdir=.h F18.hbp"
...
REM run hello.exe
bash -xlc "zip F18_${BUILD_ARTIFACT}_${F18_VERSION}.zip F18.exe"
