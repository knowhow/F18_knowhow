...
bash -xlc "export HB_ARCHITECTURE=win; export HB_COMPILER=mingw; scripts/update_f18_ver_ch.sh ${APPVEYOR_REPO_TAG_NAME}; export F18_POS=1; export F18_RNAL=1; source scripts/mingw_msys2_set_envars.sh ; hbmk2 -workdir=.h F18.hbp"
