set APPVEYOR_REPO_TAG_NAME=%F18_VERSION%
...
bash -xlc "cd /c ; curl -LO https://dl.bintray.com/bringout/harbour/harbour-windows-x86_20190316.1.zip ; mkdir hbwin ; cd hbwin ; unzip ../harbour-windows-x86_20190316.1.zip"
