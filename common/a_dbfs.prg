...
AADD(gaDBFs, { F_E_GROUPS, "E_GROUPS", "rnal_e_groups", {|alg| rnal_e_groups_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_E_GR_ATT, "E_GR_ATT", "rnal_e_gr_att", {|alg| rnal_e_gr_att_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_E_GR_VAL, "E_GR_VAL", "rnal_e_gr_val", {|alg| rnal_e_gr_val_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_AOPS, "AOPS", "rnal_aops" } )
AADD(gaDBFs, { F_AOPS_ATT, "AOPS_ATT", "rnal_aops_att" } )
AADD(gaDBFs, { F_ARTICLES, "ARTICLES", "rnal_articles", {|alg| rnal_articles_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_ELEMENTS, "ELEMENTS", "rnal_elements", {|alg| rnal_elements_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_E_AOPS, "E_AOPS", "rnal_e_aops", {|alg| rnal_e_aops_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_E_ATT, "E_ATT", "rnal_e_att", {|alg| rnal_e_att_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_CUSTOMS, "CUSTOMS", "rnal_customs", {|alg| rnal_customs_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_CONTACTS, "CONTACTS", "rnal_contacts", {|alg| rnal_contacts_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_OBJECTS, "OBJECTS", "rnal_objects", {|alg| rnal_objects_from_sql_server(alg) }, "IDS" } )
AADD(gaDBFs, { F_RAL, "RAL", "rnal_ral", {|alg| rnal_ral_from_sql_server(alg) }, "IDS" } )
