...
AADD( gaDbfs, { F_SUBAN  ,  "SUBAN"   , "fin_suban" ,  {|alg| fin_suban_from_sql_server(alg) }, "IDS" , {"idfirma", "idvn", "brnal"}, {|x| "idfirma=" + _sql_quote(x["idfirma"]) + " AND idvn=" + _sql_quote(x["idvn"]) + " AND brnal=" + _sql_quote(x["brnal"]) }, "4" })
