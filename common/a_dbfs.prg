...
AADD(gaDBFs, { F_ELEMENTS, "ELEMENTS", "rnal_elements", {|alg| rnal_elements_from_sql_server(alg) }, "IDS", { {"art_id", 10}, {"el_no", 4}, {"el_id", 10} }, {|x| "ART_ID=" + STR( x["art_id"], 10) + " AND EL_NO=" + STR( x["el_no"], 4) + " AND EL_ID=" + STR( x["el_id"], 10)  }, "1"  } )
