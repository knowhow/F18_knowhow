...
AADD( gaDbfs, { F_SUBAN  ,  "SUBAN"   , "fin_suban" ,  {|alg| fin_suban_from_sql_server(alg) }, "DATE" } )
AADD( gaDbfs, { F_ANAL   ,  "ANAL"    , "fin_anal",    {|alg| fin_anal_from_sql_server(alg)  }, "DATE" } )
AADD( gaDbfs, { F_SINT   ,  "SINT"    , "fin_sint",    {|alg| fin_sint_from_sql_server(alg)  }, "DATE" } )
AADD( gaDbfs, { F_NALOG  ,  "NALOG"   , "fin_nalog",   {|alg| fin_nalog_from_sql_server(alg) }, "DATE" } )
...
//modul KALK
AADD( gaDbfs, { F_KALK  ,"KALK" , "kalk_kalk" , {|alg| kalk_kalk_from_sql_server(alg) }, "DATE" } )
AADD( gaDbfs, { F_KALK_DOKS  ,"KALK_DOKS", "kalk_doks", {|alg| kalk_doks_from_sql_server(alg) }, "DATE" } )
...
AADD( gaDbfs, { F_FAKT_DOKS   ,"FAKT_DOKS"    , "fakt_doks"     } )
AADD( gaDbfs, { F_FAKT_DOKS2  ,"FAKT_DOKS2"   , "fakt_doks2"     } )
