...
AADD(gaDBFs, { F_LD     ,"_LD"     , "_ld"     } )
AADD(gaDBFs, { F_LD     ,"REKLD"   , "rekld"     } )
AADD(gaDBFs, { F_LD     ,"REKLDP"  , "rekldp"     } )
...
AADD(gaDBFs, { F_KRED   ,"_KRED"    , "_kred"     } )
...
AADD( gaDbfs, {  F_POS       , "POS",      "pos"      } )
AADD( gaDbfs, {  F_RNGPLA    , "RNGPLA",   "rngpla"   } )
AADD( gaDbfs, {  F__POS      , "_POS", 	   "_pos" } )
AADD( gaDbfs, {  F__PRIPR    , "_POS_PRIPR",  "_pos_pripr" } )
AADD( gaDbfs, {  F__POSP     , "_POSP",    "_posp" } )
AADD( gaDbfs, {  F__POSP     , "_POS_DOKSP",  "_pos_doksp" } )
AADD( gaDbfs, {  F_PRIPRZ    , "PRIPRZ", "priprz" } )
AADD( gaDbfs, {  F_PRIPRG    , "PRIPRG", "priprg" } )
AADD( gaDbfs, {  F_K2C       , "K2C", "k2c" } )
AADD( gaDbfs, {  F_MJTRUR    , "MJTRUR", "mjtrur" } )
AADD( gaDbfs, {  F_ROBAIZ    , "ROBAIZ", "robaiz" } )
AADD( gaDbfs, {  F_RAZDR     , "RAZDR",  "razdr" } )
AADD( gaDbfs, {  F_ROBA      , "POS_ROBA",   "pos_roba" } )
AADD( gaDbfs, {  F_SIROV     , "SIROV",  "sirov" } )
AADD( gaDbfs, {  F_SAST      , "POS_SAST",   "pos_sast" } )
AADD( gaDbfs, {  F_STRAD     , "STRAD",  "strad" } )
AADD( gaDbfs, {  F_OSOB      , "OSOB",   "osob" } )
AADD( gaDbfs, {  F_VRSTEP    , "VRSTEP", "vrstep" } )
AADD( gaDbfs, {  F_KASE      , "KASE",   "kase" } )
AADD( gaDbfs, {  F_ODJ       , "ODJ",    "odj" } )
AADD( gaDbfs, {  F_UREDJ     , "UREDJ",  "uredj" } )
AADD( gaDbfs, {  F_RNGOST    , "RNGOST", "rngost" } )
AADD( gaDbfs, {  F_DIO       , "DIO",    "dio" } )
AADD( gaDbfs, {  F_MARS      , "MARS",   "mars" } )
AADD( gaDbfs, {  F_MESSAGE   , "MESSAGE", "message" } )
AADD( gaDbfs, {  F_TMPMSG    , "TMPMSG" , "tmpmsg" } )
AADD( gaDbfs, {  F_DINTEG1   , "DINTEG1", "dinteg1" } )
AADD( gaDbfs, {  F_DINTEG2   , "DINTEG2", "dinteg2" } )
