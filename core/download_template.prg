...
FUNCTION download_all_templates()
   ...
   download_template( "rlab1.odt" ) // roba naljepnice - ovo treba biti prvi template u ovoj funkciji
   ...
   download_template( "rlab2.odt" ) // roba naljepnice - ovo treba biti zadnji template u ovoj funkciji
