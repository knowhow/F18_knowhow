...
xml_node("dmj", to_xml_encoding(cTmp, "8", "U"))
cTmp := ALLTRIM(get_dtxt_opis("D02"))
xml_node("ddok", to_xml_encoding(cTmp,"8","U"))
cTmp := ALLTRIM(get_dtxt_opis("D04"))
xml_node("dslovo", to_xml_encoding(cTmp,"8","U"))
...
xml_node("ddest", to_xml_encoding(cTmp,"8","U"))
...
xml_node("dsign", to_xml_encoding(cTmp,"8","U"))
...
next
xml_node("dveza", to_xml_encoding(cTmp,"8","U"))

// zaglavlje
cTmp := ALLTRIM(get_dtxt_opis("I01"))
xml_node("fnaz", to_xml_encoding(cTmp,"8","U"))
cTmp := ALLTRIM(get_dtxt_opis("I02"))
xml_node("fadr", to_xml_encoding(cTmp,"8","U"))
...
xml_node("fdt1", to_xml_encoding(cTmp,"8","U"))
cTmp := ALLTRIM(get_dtxt_opis("I13"))
xml_node("fdt2", to_xml_encoding(cTmp,"8","U"))
cTmp := ALLTRIM(get_dtxt_opis("I14"))
xml_node("fdt3", to_xml_encoding(cTmp,"8","U"))

// partner
xml_node("knaz", to_xml_encoding(ALLTRIM(get_dtxt_opis("K01")),"8","U") )
xml_node("kadr", to_xml_encoding(ALLTRIM(get_dtxt_opis("K02")),"8","U") )
xml_node("kid", to_xml_encoding(ALLTRIM(get_dtxt_opis("K03")), "8", "U" ))
xml_node("kpbr", ALLTRIM(get_dtxt_opis("K05")) )
xml_node("kmj", to_xml_encoding(ALLTRIM(get_dtxt_opis("K10")),"8","U") )
...
for i := 20 to ( 20 + nTxtR )
	...
	xml_subnode("text", .f.)
	xml_node("row", to_xml_encoding(cTmpTxt,"8","U") )
	xml_subnode("text", .t.)
...
do while !EOF()
	...
	xml_node( "id", to_xml_encoding(ALLTRIM( field->idroba ),"8","U") )
	xml_node( "naz", to_xml_encoding(ALLTRIM( field->robanaz ),"8","U" ))
	xml_node( "jmj", to_xml_encoding(ALLTRIM( field->jmj ), "8", "U") )
	...
	xml_node( "c1", to_xml_encoding( ALLTRIM( field->c1 ), "8", "U" ) )
	xml_node( "c2", to_xml_encoding( ALLTRIM( field->c2 ), "8", "U" ) )
	xml_node( "c3", to_xml_encoding( ALLTRIM( field->c3 ), "8", "U" ) )
	xml_node( "opis", to_xml_encoding( ALLTRIM( field->opis ), "8", "U" ) )
