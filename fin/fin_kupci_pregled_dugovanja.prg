...
FUNCTION fin_kupci_pregled_dugovanja()
   ...
   @ form_x_koord() + 1, Col() + 2 SAY "do" GET dDatDo
   @ form_x_koord() + 3, form_y_koord() + 2  SAY "Konto% duguje: " GET cIdKonto
   @ form_x_koord() + 4, form_y_koord() + 2  SAY "Partner% (prazno svi): " GET cIdPartner
   @ form_x_koord() + 5, form_y_koord() + 2  SAY8 "Prikaz kupaca koji su u avansu D/N?" GET cAvans PICT "@!" VALID cAvans $ "DN"
