...
FUNCTION SpecSubPro()
   ...
   DO WHILE .T.
      @ form_x_koord() + 1, form_y_koord() + 6 SAY "SPECIFIKACIJA SUBANALITIKA - PROIZV.SORT."
      IF gNW == "D"
      ...
      @ form_x_koord() + 9, form_y_koord() + 2 SAY "Kriterij za telefon" GET qqTel PICT "@!S30"
      @ form_x_koord() + 11, form_y_koord() + 2 SAY "Sortirati po: konto+telefon+partn (1)" GET cSort VALID csort $ "12"

      @ form_x_koord() + 15, form_y_koord() + 2 SAY ""

      IF fk1
         @ form_x_koord() + 15, form_y_koord() + 2 SAY "K1 (9 svi) :" GET cK1
      ENDIF
      IF fk2
         @ form_x_koord() + 15, Col() + 2 SAY "K2 (9 svi) :" GET cK2
      ENDIF
      IF fk3
         @ form_x_koord() + 15, Col() + 2 SAY "K3 (" + cK3 + " svi):" GET cK3
      ENDIF
      IF fk4
         @ form_x_koord() + 15, Col() + 2 SAY "K4 (99 svi):" GET cK4
      ENDIF
