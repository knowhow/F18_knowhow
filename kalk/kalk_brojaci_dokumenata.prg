...
FUNCTION kalk_set_param_broj_dokumenta()
   ...
   IF glBrojacPoKontima
      @ form_x_koord() + 1, Col() + 1 SAY " konto:" GET _konto
   ENDIF
   ...
   @ form_x_koord() + 2, form_y_koord() + 2 SAY "Zadnji broj dokumenta:" GET _broj PICT "99999999"
...
FUNCTION get_kalk_brdok( _idfirma, _idvd, _idkonto, _idkonto2 )
   ...
   IF is_brojac_po_kontima()
      ...
      IF _idvd $ "10#16#18#IM#"
         @ form_x_koord() + 2, form_y_koord() + 2 SAY8 "Magacinski konto: " GET _idKonto VALID P_Konto( @_idKonto ) PICT "@!"
         READ

         cIdKonto := _idKonto
      ELSE
         @ form_x_koord() + 2, form_y_koord() + 2 SAY8 "Prodavnički konto: " GET _idKonto2 VALID P_Konto( @_idKonto2 ) PICT "@!"
         READ
         cIdKonto := _idKonto2
      ENDIF
      BoxC()
