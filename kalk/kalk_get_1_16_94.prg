...
FUNCTION kalk_get_1_94()
   ...
   IF nRbr == 1 .OR. !kalk_is_novi_dokument() .OR. gMagacin == "1"
      ...
      // IF gNW <> "X"
      // @ form_x_koord() + 9, form_y_koord() + 40 SAY "Zaduzuje:" GET _IdZaduz   PICT "@!"  VALID Empty( _idZaduz ) .OR. p_partner( @_IdZaduz, 21, 5 )
      // ELSE
      IF !Empty( cRNT1 )
      ...
      IF _idvd == "16"
         ...
         // IF gNW <> "X"
         // @ form_x_koord() + 10, form_y_koord() + 35  SAY "Zaduzuje: "   GET _IdZaduz2  PICT "@!" VALID Empty( _idZaduz ) .OR. p_partner( @_IdZaduz2, 21, 5 )
         // ENDIF
      ENDIF
   ...
   ELSE
      ...
      // IF gNW <> "X"
      // @ form_x_koord() + 9, form_y_koord() + 40 SAY "Zaduzuje: "; ?? _IdZaduz
      // ENDIF
   ...
   kalk_pripr_form_get_roba( @_idRoba, @_idTarifa, _IdVd, kalk_is_novi_dokument(), form_x_koord() + 11, form_y_koord() + 2, @aPorezi, _idPartner )
   ...
   @ form_x_koord() + 13, form_y_koord() + 2    SAY "NAB.CJ   "  GET _NC  PICTURE gPicNC  WHEN V_kol10()
