...
FUNCTION Rfinansijsko_stanje_prodavnica()
   ...
   DO WHILE .T.
      ...
      @ form_x_koord() + 5, form_y_koord() + 2 SAY "Artikli " GET qqRoba   PICT "@!S50"
      ...
      @ form_x_koord() + 8, form_y_koord() + 2  SAY "Prikaz: roba tipa T / dokumenata IP (1/2)" GET cTU  VALID cTU $ "12"
      READ
      ESC_BCR
