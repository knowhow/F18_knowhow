...
FUNCTION RobaIdSredi()
   ...
   DO WHILE .T.
      @ form_x_koord() + 6, form_y_koord() + 2 SAY "                 "
      @ form_x_koord() + 1, m_Y + 2 SAY "ISPRAVKA SIFRE ARTIKLA U DOKUMENTIMA"
      @ form_x_koord() + 2, m_Y + 2 SAY "Stara sifra:" GET cSifOld PICT "@!"
      @ form_x_koord() + 3, m_Y + 2 SAY "Nova  sifra:" GET cSifNew PICT "@!" VALID !Empty( cSifNew )
      READ
      ESC_BCR
      ...
      DO WHILE Found()
         ...
         @ m_X + 5, form_y_koord() + 2 SAY ++nRbr PICT "999"
         CONTINUE
      ENDDO
      ...
      ENDDO
      Beep( 2 )
      @ form_x_koord() + 6, form_y_koord() + 2 SAY "Sifra promijenjena"
   ENDDO  // .t.
