...
FUNCTION ld_specifikacija_plate_obr_2001()
   ...
   LOCAL cDoprNa1 := fetch_metric( "ld_specifikacija_doprinos_5", NIL, "20" )
   LOCAL cDoprNa2 := fetch_metric( "ld_specifikacija_doprinos_6", NIL, "21" )
...
*/
   ...
   set_metrgic( "ld_specifikacija_minuli_rad", NIL, cMRad )
