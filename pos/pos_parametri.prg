...
//AADD(aNiz, {"Naziv fajla zaglavlja racuna" , "gRnHeder", "pos_v_file(@gRnHeder,'zaglavlja')","@!", })
//AADD(aNiz, {"Naziv fajla podnozja racuna" , "gRnFuter", "pos_v_file(@gRnFuter,'podnozja')","@!", })
