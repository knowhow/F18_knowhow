...
// -----------------------------------------------
FUNCTION rnal_doc_delta( nDoc_no, cDesc )
...
// --------------------------------------
STATIC FUNCTION item_value( nDoc_no, nDoc_it_no, nArt_id, nDoc_it_qtty, nDoc_it_heigh, nDoc_it_width, lKumul )
...
FUNCTION _lit_21_get( nDoc_no, nDoc_log_no )
   ...
   DO WHILE !Eof() .AND. field->doc_no == nDoc_no .AND. field->doc_log_no == nDoc_log_no
