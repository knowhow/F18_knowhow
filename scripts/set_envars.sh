...
MODULES="$MODULES base reporting admin brojaci partner konto roba parametri string semaphores dbf_create sql sql_data_access fiskalizacija pdv ui_1990  print"
